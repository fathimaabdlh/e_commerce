...
import 'package:main_project_/Model/Wishlist/Wishlist%20Add/wishAdd.dart';
...
class WishAddDataService extends ChangeNotifier {
  final wishserviceAdd = AddDataWish();
  ...
  addData(id) async {
    // isloading = true;
    notifyListeners();
    await wishserviceAdd.WishAddData(id);
