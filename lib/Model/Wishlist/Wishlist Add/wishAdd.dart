// ignore_for_file: unnecessary_brace_in_string_interps, await_only_futures, unnecessary_string_interpolations, unused_import, non_constant_identifier_names
import 'dart:convert';
...
class AddDataWish {
  Future<void> WishAddData(dynamic id) async {
    try {
