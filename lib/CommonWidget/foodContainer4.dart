...
import 'package:main_project_/categories/jwelleryPage.dart';
import 'package:provider/provider.dart';
import 'package:sizer/sizer.dart';

class FoodContainer4 extends StatelessWidget {
  const FoodContainer4({Key? key});
      ...
      if (provider.isLoading || provider.homeData == null) {
        ...
        return SizedBox(
            ...
            child: ListView.builder(
                itemCount:
                    provider.homeData?.categorizedProducts?.jwellery?.length ??
                        0,
