      ...
      if (provider.isLoading || provider.homeData == null) {
        ...
        return SizedBox(
            ...
            child: ListView.builder(
                itemCount: provider
                        .homeData?.categorizedProducts?.electronics?.length ??
                    0,
                scrollDirection: Axis.horizontal,
                itemBuilder: (context, index) {
                  final Electronic = provider
                    ...
                    onTap: () {
                      Navigator.push(context,
                        ...
                        return ElectronicsPage(
                            productName: Electronic.name.toString(),
                            productImage: Electronic.image.toString(),
                            productPrice: Electronic.price.toString(),
                            productId: Electronic.id.toString());
                      }));
                    },
                    child: Padding(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        'http://$ip:3000/products-images/${Electronic!.image!}',
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
